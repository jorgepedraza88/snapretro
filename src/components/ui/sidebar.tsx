  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'relative h-svh w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear dark:bg-neutral-800',
...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<'main'>>(
  ({ className, ...props }, ref) => {
    return (
      <main
        ref={ref}
        data-side="right" // Agregado para indicar alineación a la derecha
        className={cn(
          'relative flex min-h-svh flex-1 flex-col bg-white dark:bg-neutral-950',
          'peer-data-[variant=inset]:min-h-[calc(100svh-theme(spacing.4))]',
          'md:peer-data-[variant=inset]:m-2 md:peer-data-[state=collapsed]:peer-data-[variant=inset]:mr-2',
